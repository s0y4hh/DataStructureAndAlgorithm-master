...
def main():
    ...
    while 1:
        ...
        head_1 = queue_1.head.data if queue_1.head else float('inf')
        head_2 = queue_2.head.data if queue_2.head else float('inf')
        head_3 = queue_3.head.data if queue_3.head else float('inf')
